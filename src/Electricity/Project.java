...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        Image i3 = ic.getImage().getScaledInstance(1520,780,Image.SCALE_DEFAULT);
        ...
        /* ---- Meter Details ---- */
        m2.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        m2.setBackground(Color.WHITE);
         ...
         /* ---- Deposit Details  ----- */
        m3.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        m4.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Pay Bill ---- */
        info1.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Last Bill ----*/
        info2.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Pay Bill ---- */
        u1.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Last Bill ----*/
        u3.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Report ---- */
        r1.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Calender ---- */
        ut1.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Calculator ---- */
        ut2.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Web Browser ---- */
        ut3.setFont(new Font("monospaced",Font.PLAIN,25));
        ...
        /* ---- Exit ---- */
        ex.setFont(new Font("monospaced",Font.PLAIN,25));
